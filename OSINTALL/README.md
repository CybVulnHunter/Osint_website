# 🛠️ OSINT & Cyber Tools Collection

A curated list of OSINT (Open Source Intelligence), identity generation, emulators, productivity enhancers, and cybersecurity tools. This collection is meant for ethical hackers, researchers, and cyber professionals to test, research, analyze, or conduct investigations.

> ⚠️ **Disclaimer**: These tools are for educational and research purposes only. Use them ethically and responsibly.
...
Disposable Secure Browser or Desktop
...
[Ph055a OSINT\_Collection](https://github.com/Ph055a/OSINT_Collection)
...
[Reddit\_Persona](https://github.com/n2itn/reddit_persona)
...
Scanner Frequencies and Radio Frequency Reference Database

[Feeds.talonvoice.com](https://feeds.talonvoice.com/)

This a website transcribing scanner feeds to text in real-time, in response to recent events
...
[@murph\_live](https://twitter.com/murph_live)
...
[fgdc\_gp\_demos's public fiddles](https://jsfiddle.net/user/fgdc_gp_demos/fiddles/)
...
[Toronto Police Service](https://bloopbase.keybase.pub/ACAB/TPS/index.html)

[Royal Canadian Mounted Police](https://bloopbase.keybase.pub/ACAB/RCMP/index.html)

[Ontario Provincial Police](https://bloopbase.keybase.pub/ACAB/OPP/index.html)
...
[Maldives Sex Offender](http://www.offenders.mv/offenders/)
...
[Trouver une décision](http://citoyens.soquij.qc.ca/)
...
[Montreal Council of Social Agencies Database](http://www.archives.mcgill.ca/resources/db/mcsasearch.htm)
